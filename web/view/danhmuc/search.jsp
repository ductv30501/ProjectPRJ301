                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><%=d.getMaLoaiSP()%></td>
                                            <td><%=d.getLoaiSP()%></td>
                                            <td><a href="edit?id=<%=d.getMaLoaiSP()%>"><img style="width: 20px" src="../img/edit.png" alt=""/></a> 
                                                <a href="delete?id=<%=d.getMaLoaiSP()%>" onclick="return confirm('Bạn có muốn xóa' +<%=d.getLoaiSP()%> + ' không?')" ><img style="width: 20px" src="../img/delete.png" alt=""/></a>
                                            </td>
                                        </tr>
                                        <%}%>
                                    </tbody>
